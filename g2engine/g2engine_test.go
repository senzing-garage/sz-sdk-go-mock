...
func getG2Engine(ctx context.Context) *G2engine {
	if g2engineSingleton == nil {
		g2engineSingleton = &G2engine{
			AddRecordWithInfoResult:                      ``,
			AddRecordWithInfoWithReturnedRecordIDResult1: ``,
			AddRecordWithInfoWithReturnedRecordIDResult2: ``,
			AddRecordWithReturnedRecordIDResult:          ``,
			CheckRecordResult:                            ``,
			CountRedoRecordsResult:                       int64(1),
			DeleteRecordWithInfoResult:                   ``,
			ExportConfigResult:                           ``,
			ExportConfigAndConfigIDResult1:               ``,
			ExportConfigAndConfigIDResult2:               int64(1),
			ExportCSVEntityReportResult:                  1,
			ExportJSONEntityReportResult:                 1,
			FetchNextResult:                              ``,
			FindInterestingEntitiesByEntityIDResult:      ``,
			FindInterestingEntitiesByRecordIDResult:      ``,
			FindNetworkByEntityID_V2Result:               ``,
			FindNetworkByEntityIDResult:                  ``,
			FindNetworkByRecordID_V2Result:               ``,
			FindNetworkByRecordIDResult:                  ``,
			FindPathByEntityID_V2Result:                  ``,
			FindPathByEntityIDResult:                     ``,
			FindPathByRecordID_V2Result:                  ``,
			FindPathByRecordIDResult:                     ``,
			FindPathExcludingByEntityID_V2Result:         ``,
			FindPathExcludingByEntityIDResult:            ``,
			FindPathExcludingByRecordID_V2Result:         ``,
			FindPathExcludingByRecordIDResult:            ``,
			FindPathIncludingSourceByEntityID_V2Result:   ``,
			FindPathIncludingSourceByEntityIDResult:      ``,
			FindPathIncludingSourceByRecordID_V2Result:   ``,
			FindPathIncludingSourceByRecordIDResult:      ``,
			GetActiveConfigIDResult:                      int64(1),
			GetEntityByEntityID_V2Result:                 ``,
			GetEntityByEntityIDResult:                    ``,
			GetEntityByRecordID_V2Result:                 ``,
			GetEntityByRecordIDResult:                    ``,
			GetRecord_V2Result:                           ``,
			GetRecordResult:                              ``,
			GetRedoRecordResult:                          ``,
			GetRepositoryLastModifiedTimeResult:          int64(1),
			GetVirtualEntityByRecordID_V2Result:          ``,
			GetVirtualEntityByRecordIDResult:             ``,
			HowEntityByEntityID_V2Result:                 ``,
			HowEntityByEntityIDResult:                    ``,
			ProcessRedoRecordResult:                      ``,
			ProcessRedoRecordWithInfoResult1:             ``,
			ProcessRedoRecordWithInfoResult2:             ``,
			ProcessWithInfoResult:                        ``,
			ProcessWithResponseResult:                    ``,
			ProcessWithResponseResizeResult:              ``,
			ReevaluateEntityWithInfoResult:               ``,
			ReevaluateRecordWithInfoResult:               ``,
			ReplaceRecordWithInfoResult:                  ``,
			SearchByAttributes_V2Result:                  ``,
			SearchByAttributesResult:                     ``,
			StatsResult:                                  ``,
			WhyEntities_V2Result:                         ``,
			WhyEntitiesResult:                            ``,
			WhyEntityByEntityID_V2Result:                 ``,
			WhyEntityByEntityIDResult:                    ``,
			WhyEntityByRecordID_V2Result:                 ``,
			WhyEntityByRecordIDResult:                    ``,
			WhyRecords_V2Result:                          ``,
			WhyRecordsResult:                             ``,
		}
	}
