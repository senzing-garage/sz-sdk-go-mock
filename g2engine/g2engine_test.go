...
func getG2Engine(ctx context.Context) *G2engine {
	if g2engineSingleton == nil {
		g2engineSingleton = &G2engine{
			...
			FindNetworkByEntityID_V2Result:                         `{"ENTITY_PATHS":[],"ENTITIES":[{"RESOLVED_ENTITY":{"ENTITY_ID":1,"ENTITY_NAME":"Robert Smith","RECORD_SUMMARY":[{"DATA_SOURCE":"CUSTOMERS","RECORD_COUNT":3,"FIRST_SEEN_DT":...`,
			...
			ProcessRedoRecordWithInfoResult:                        ``,
			...
			WhyRecords_V2Result:                                    `{"WHY_RESULTS":[{"INTERNAL_ID":1,"ENTITY_ID":1,"FOCUS_RECORDS":[{"DATA_SOURCE":"CUSTOMERS","RECORD_ID":"1001"}],`,
